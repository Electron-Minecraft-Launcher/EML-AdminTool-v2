...
> [!CAUTION]
> EML AdminTool v2.0.0-beta.3 is a breaking upgrade from EML AdminTool v2.0.0-beta.1: all your data will be lost during the upgrade. Please make sure to back up your data before upgrading. Additionally, you cannot upgrade to beta 3 using the "Update" button. **Please install EML AdminTool v2.0.0-beta.3 as a fresh installation.**
...
* Implementing [Prisma](https://www.prisma.io/) as the database ORM with PostgreSQL as the database.
* Using [EML AdminTool Updater](https://github.com/Electron-Minecraft-Launcher/EML-AdminTool-Updater) for EML AdminTool updates.
...
* Added news preview.
* Added Danish, German, Italian and Japanese translations.
